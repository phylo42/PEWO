...
def get_placement(jplace_filename: str) -> Tuple[int, str]:
    """
...
def get_node_by_id(tree: Phylo.BaseTree, postorder_node_id: int):
    """
...
if __name__ == "__main__":
    ...
    branch_id, seq_name = get_placement(jplace_file)
